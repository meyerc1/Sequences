...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([3, 5, 7, 9])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = (22 + 23 + 24)
    actual = sum_first_n([22, 23, 24, 25], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    actual = sum_first_n([-10, -20, 30, 0.000000000000001, 1010101010101010101], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
